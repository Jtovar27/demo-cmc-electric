...
const navItems = [
  ...
  { icon: BookOpen, label: "Courses", href: "/admin/cursos" },
  { icon: Users, label: "Students", href: "/admin/estudiantes" },
  { icon: Wrench, label: "Services", href: "/admin/servicios" },
  { icon: FileText, label: "Blog", href: "/admin/blog" },
  { icon: HelpCircle, label: "FAQ", href: "/admin/faq" },
  { icon: Settings, label: "Configuration", href: "/admin/configuracion" },
];
        ...
        <div className="p-4 border-t border-[#1A1A1A]">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[10px] font-mono text-[#FFD700]/60 truncate">
                Administrator
              </p>
            </div>
          </div>
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 text-xs font-mono tracking-wide text-[#606060] hover:text-red-400 hover:bg-red-500/5 transition-all"
          >
